...
public class DESTarget implements PIDSource {
    ...
    public static MonoImage extractThirdColorPlane(NIVision.ColorMode mode, BinaryImage inputImage) throws NIVisionException {
       MonoImage result = new MonoImage();
        try {
            NIVision.extractColorPlanes(inputImage.image, mode, null, null, result.image);
