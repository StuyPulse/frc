...
public class DESTarget {
    ...
    public static DESTarget[] findCircularTargets(ColorImage image) throws NIVisionException { //include gregs other parameters?
        ...
        BinaryImage threshPlane = lumPlane.thresholdHSL(0,256,0,256,211,256);
        

        EllipseMatch[] results = threshPlane.detectEllipses(ellipseDescriptor, curveOptions, shapeOptions, null);
