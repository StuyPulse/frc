...
public class DonovanDriveTrain extends RobotDrive implements Ports {
    ...
    public DonovanDriveTrain(int motor1, int motor2, int motor3, int motor4, DonovanNoCam d) {
  ...
  */
    ...
    public void resetEncoders() {
		...
		while (getAvgDistance() < inches && donnie.isAutonomous() && donnie.isEnabled() && Timer.getUsClock() - startTime < 5000000) {
			arcadeDrive(-0.4, 0.0);
		}
		arcadeDrive(0.0,0.0);
