...
public class Autonomous {
    ...
    public Autonomous(DonovanNoCam d) {
        donnie = d;
    }

    /**
     * Runs a given autonomous setting.  Called in DonovanNoCam.autonomous()
     * @param settingNum The setting number to run, comes from a DonovanNoCamOI
     */
    public void runSettingNum(int settingNum) {
        // called in DonovanNoCam.autonomous(),
        // argument comes from DonovanNoCamOI
