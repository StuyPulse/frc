 ...
 * directory.
 */
public class DonovanPIDTuner extends SimpleRobot implements Ports, ThreeLaws {
    ...
    int pScale = 50; // one tick is a .0001       ONE TEN-THOUSANDTH       1 x 10^-4
    int iScale = 5000;  // one tick is a .000001  ONE MILLIONTH            1 x 10^-6
    int dScale = 5000; // one tick is a .000001   ONE MILLIONTH            1 x 10^-6
    AnalogChannel pChannel;
    AnalogChannel iChannel;
    AnalogChannel dChannel;

    public DonovanPIDTuner() {
        ...
        pChannel = new AnalogChannel(P_TUNE_CHANNEL);
        iChannel = new AnalogChannel(I_TUNE_CHANNEL);
        dChannel = new AnalogChannel(D_TUNE_CHANNEL);
