...
public class DonovanDriveTrain extends RobotDrive implements Ports {
    ...
    public DonovanDriveTrain(int motor1, int motor2, int motor3, int motor4, DonovanPIDTuner d) {
        ...
        straightController = new PIDController(donnie.pRead, donnie.iRead, donnie.dRead, donnie.gyro, new PIDOutput() {
