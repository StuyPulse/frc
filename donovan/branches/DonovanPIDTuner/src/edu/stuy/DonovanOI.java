...
public class DonovanOI implements Ports {
    ...
    private DonovanPIDTuner donnie;
    Timer timer;


    //Might not have to pass a donovan object -EM
    public DonovanOI(DonovanPIDTuner d) {
        donnie = d;
    ...
    public void setPID(){
        donnie.pRead = donnie.pChannel.getVoltage()/donnie.pScale;
        donnie.iRead = donnie.iChannel.getVoltage()/donnie.iScale;
        donnie.dRead = donnie.dChannel.getVoltage()/donnie.dScale;
        System.out.println("P: " + donnie.pRead + "  I: " + donnie.iRead + "  D: " + donnie.dRead);
    }
