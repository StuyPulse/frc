 ...
 */
INT16 AnalogChannel::GetValue(void)
{
 ...
 */
INT32 AnalogChannel::GetAverageValue(void)
{
 ...
 */
UINT32 AnalogChannel::GetLSBWeight(void)
{
 ...
 */
INT32 AnalogChannel::GetOffset(void)
{
 ...
 */
UINT32 AnalogChannel::GetChannel(void)
{
	return m_channel;
}
 ...
 */
UINT32 AnalogChannel::GetSlot(void)
{
 ...
 */
UINT32 AnalogChannel::GetAverageBits(void)
{
 ...
 */
UINT32 AnalogChannel::GetOversampleBits(void)
{
 ...
 */
bool AnalogChannel::IsAccumulatorChannel(void)
{
 ...
 */
void AnalogChannel::InitAccumulator(void)
{
	m_accumulatorOffset = 0;
 ...
 */
void AnalogChannel::ResetAccumulator(void)
{
 ...
 */
INT64 AnalogChannel::GetAccumulatorValue(void)
{
	if (m_accumulator == NULL)
	{
		wpi_fatal(NullParameter);
 ...
 */
UINT32 AnalogChannel::GetAccumulatorCount(void)
{
	status = 0;
	if (m_accumulator == NULL)
	{
