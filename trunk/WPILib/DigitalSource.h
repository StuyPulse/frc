...
public:
	...
	virtual UINT32 GetChannelForRouting(void) = 0;
	virtual UINT32 GetModuleForRouting(void) = 0;
	virtual bool GetAnalogTriggerForRouting(void) = 0;
	virtual void RequestInterrupts(tInterruptHandler handler) = 0;
	virtual void RequestInterrupts(void) = 0;
};
