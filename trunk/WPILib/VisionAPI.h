...
typedef struct ParticleAnalysisReport_struct {
	...
	/* Distance between the highest particle point y-coordinate and the lowest particle point y-coordinate.  */
	double 	boundingRectangleHeight;	// MeasurementType: IMAQ_MT_BOUNDING_RECT_HEIGHT
	/* Distance between the leftmost particle point x-coordinate and the rightmost particle point x-coordinate. */
	double 	boundingRectangleWidth;		// MeasurementType: IMAQ_MT_BOUNDING_RECT_WIDTH
