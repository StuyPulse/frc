 ...
 */
Error& ErrorBase::GetError(void)
{	return error;  }

const Error& ErrorBase::GetError(void) const
{	return error;  }

/**
 * @brief Clear the current error information associated with this sensor.
 */
void ErrorBase::ClearError(void)
{	error.Clear();  }
...
*/
bool ErrorBase::StatusIsFatal(void) const {
